  ...
  layers: [
    new Tile({
      ...
      source: new XYZ({
        ...
        url: 'https://mapy.geoportal.gov.pl/wss/service/PZGIK/ORTO/REST/StandardResolution/tile/{z}/{y}/{x}',
      }),
    }),
  ],
});
  ...
  layers: [
    new Tile({
      ...
      source: new XYZ({
        ...
        maxZoom: 16,
        crossOrigin: 'Anonymous',
        url: 'https://mapy.geoportal.gov.pl/wss/service/PZGIK/ORTO/REST/HighResolution/tile/{z}/{y}/{x}',
      }),
    }),
  ],
});
